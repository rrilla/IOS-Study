...
class ViewController: UIViewController {
    ...
    @IBAction func btnLampOff(_ sender: UIButton) {
        if(isLampOn){
            let lampOffAlert = UIAlertController(title: "전구끄기", message: "전구 끌꺼?", preferredStyle: UIAlertController.Style.alert)
            let offAction = UIAlertAction(title: "네, 꺼주세요.", style: UIAlertAction.Style.default,
                                          handler: {
    ...
    @IBAction func btnLampRemove(_ sender: UIButton) {
        let lampRemoveAlert = UIAlertController(title: "램프 제거", message: "램프 제거 할꺼?", preferredStyle: UIAlertController.Style.alert)
